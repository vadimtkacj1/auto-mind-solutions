      ...
      >
        <div className="max-w-[1000px] mx-auto">
          <article itemScope itemType="https://schema.org/Article">
            <header>
              <h1 className="mb-8 text-5xl font-black text-[var(--color-dark)]" itemProp="headline">
                תנאי שימוש
              </h1>
            ...
            <div itemProp="description">
              <p className="mb-8 text-gray-600 text-xl leading-relaxed">
                אנא קרא/י בעיון את תנאי השימוש הבאים לפני השימוש באתר ובשירותים שלנו. השימוש באתר מהווה הסכמה מלאה
                לתנאים אלו.
              </p>
            </div>
            ...
            <div className="space-y-8 bg-gray-50 rounded-[32px] p-8 lg:p-12 border-4 border-gray-200">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  בכניסה ושימוש באתר Aiterra Solutions, את/ה מסכים/ה לתנאי השימוש המפורטים להלן. אם אינך מסכים/ה לתנאים
                  אלו, נא להימנע משימוש באתר.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  תנאים אלו חלים על כל המבקרים, המשתמשים והלקוחות של האתר. השימוש באתר מותר רק לאנשים מעל גיל 18 או
                  לקטינים בהסכמת הורה או אפוטרופוס.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-white p-4 rounded-lg">
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      <strong>&quot;אנו&quot;, &quot;שלנו&quot;, &quot;החברה&quot;:</strong> מתייחס ל-Aiterra Solutions
                    </li>
                    <li>
                      <strong>&quot;את/ה&quot;, &quot;המשתמש&quot;, &quot;הלקוח&quot;:</strong> מתייחס לכל אדם המשתמש
                      באתר או בשירותים
                    </li>
                    <li>
                      <strong>&quot;האתר&quot;:</strong> מתייחס לאתר האינטרנט של Aiterra Solutions
                    </li>
                    <li>
                      <strong>&quot;שירותים&quot;:</strong> כל השירותים שמציעה החברה, כולל עיצוב, פיתוח, SEO, ייעוץ
                      דיגיטלי ועוד
                    </li>
                    <li>
                      <strong>&quot;תוכן&quot;:</strong> כל הטקסטים, תמונות, גרפיקה, קוד, תוכנה וחומרים אחרים באתר
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Aiterra Solutions מספקת שירותי בניית אתרים, אוטומציה שיווקית, פרסום ממומן, SEO, ייעוץ דיגיטלי, תחזוקת
                  אתרים ושירותים נוספים כמפורט באתר.
                </p>
                <div className="bg-white p-4 rounded-lg">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  כל התוכן באתר, כולל אך לא רק: טקסטים, גרפיקה, לוגואים, תמונות, איורים, קוד, תוכנה, בסיסי נתונים,
                  עיצובים, סמלים, סימני מסחר, פטנטים וחומרים אחרים, הם רכושה הבלעדי של Aiterra או של בעלי הזכויות
                  הרלוונטיים ומוגנים בחוקי זכויות יוצרים, סימני מסחר וקניין רוחני אחרים.
                </p>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-700 font-medium mb-2">הגבלות שימוש:</p>
                  <ul className="list-disc list-inside space-y-2 text-gray-600">
                    <li>
                      אין להעתיק, לשכפל, להפיץ, לפרסם, להציג בפומבי, לשדר, לשנות, ליצור יצירות נגזרות או להשתמש בתוכן
                      ללא אישור בכתב מראש
                    </li>
                ...
                <p className="text-gray-600 leading-relaxed mt-4">
                  <strong>פרויקטים ללקוחות:</strong> פרויקטים שנבנו עבור לקוחות, כולל קוד, עיצובים ותוכן ייחודי, נשארים
                  בבעלות הלקוח לאחר תשלום מלא של כל התשלומים המגיעים. עם זאת, החברה שומרת לעצמה את הזכות להשתמש
                  בפרויקטים כחלק מתיק העבודות שלה (portfolio) אלא אם נקבע אחרת בהסכם.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  השירותים ניתנים &quot;כמות שהם&quot; (AS IS) ללא אחריות מפורשת או משתמעת, כולל אך לא רק: אחריות
                  למכירות, התאמה למטרה מסוימת, אי הפרת זכויות, איכות, ביצועים או דיוק.
                </p>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-700 font-medium mb-2">הגבלות אחריות:</p>
                  <ul className="list-disc list-inside space-y-2 text-gray-600">
                    <li>
                      אנו מתחייבים לעבוד באיכות מקצועית גבוהה, אך איננו אחראים לנזקים עקיפים, תוצאתיים, מקריים או
                      מיוחדים
                    </li>
                    <li>
                      אחריותנו מוגבלת לתיקון ליקויים ושיפורים במסגרת תקופת האחריות המפורטת בהסכם (בדרך כלל 30-90 יום)
                    </li>
                    <li>
                      איננו אחראים לנזקים הנובעים משימוש לא נכון, שינויים שבוצעו על ידי הלקוח או צדדים שלישיים, או
                      אירועים מחוץ לשליטתנו
                    </li>
                    <li>האחריות הכוללת שלנו מוגבלת לסכום ששולם עבור השירות הספציפי</li>
                    <li>
                      איננו מתחייבים לתוצאות ספציפיות (כגון דירוגים ב-SEO או מכירות) אלא רק לביצוע העבודה המקצועית
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  אם את/ה מעלה, שולח או מספק תוכן כלשהו לאתר (כגון הערות, משוב, תמונות, קבצים), את/ה מעניק/ה לחברה
                  רישיון בלתי מוגבל, בלתי ניתן לביטול, חופשי מתמלוגים להשתמש, לשכפל, לשנות, להפיץ ולהציג את התוכן למטרות
                  שירות, שיווק ופיתוח.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  את/ה מתחייב/ת שהתוכן שתספק אינו מפר זכויות של אחרים, אינו בלתי חוקי, פוגעני או מזיק, ואת/ה בעל/ת
                  הזכויות המלאות על התוכן.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  האתר עשוי להכיל קישורים לאתרים חיצוניים של צדדים שלישיים. אנו לא בודקים, לא מאשרים ולא אחראים לתוכן,
                  מדיניות הפרטיות או הפרקטיקות של אתרים אלו. הגישה לאתרים חיצוניים היא על אחריותך הבלעדית. אנו ממליצים
                  לך לקרוא את תנאי השימוש ומדיניות הפרטיות של כל אתר שבו אתה מבקר.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  אנו מתחייבים לשמור על סודיות ופרטיות המידע שלך. לפרטים מלאים על איסוף, שימוש והגנה על המידע האישי שלך,
                  עיין/י במדיניות הפרטיות שלנו.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  אנו נוקטים באמצעי אבטחה מתקדמים אך איננו יכולים להבטיח הגנה מוחלטת מפני פריצות, גישה לא מורשית, אובדן
                  או שינוי מידע. השימוש באתר הוא על אחריותך, ואת/ה מסכים/ה שלא נשמור על החברה מפני נזקים הנובעים משימוש
                  באתר.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  את/ה מסכים/ה לפצות ולשחרר את Aiterra Solutions, עובדיה, מנהליה, שותפיה וספקיה מכל תביעות, נזקים,
                  הפסדים, אחריות, הוצאות ועמלות (כולל עמלות עורכי דין) הנובעים משימוש באתר או בשירותים, הפרת תנאים אלו,
                  הפרת זכויות של אחרים, או כל פעולה או מחדל שלך.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  כל סכסוך, מחלוקת או תביעה הנובעת מתנאים אלו או קשורה אליהם ייפתר תחילה באמצעות משא ומתן ישיר. אם לא
                  יושג פתרון תוך 30 יום, הסכסוך יועבר לבוררות בהתאם לחוק הבוררות הישראלי.
                </p>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  אנו שומרים לעצמנו את הזכות להשהות או לבטל את הגישה שלך לאתר או לשירותים בכל עת, ללא הודעה מוקדמת, אם
                  את/ה מפר/ה תנאים אלו, משתמש/ת באתר למטרות בלתי חוקיות, או מפר/ה כל חוק או תקנה. ביטול לא ישחרר אותך
                  מחובות תשלום או אחריות שהתחייבות לפני הביטול.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  כל הודעות רשמיות יישלחו לכתובת האימייל שסיפקת או יפורסמו באתר. את/ה מסכים/ה לקבל הודעות אלקטרוניות,
                  כולל הודעות שיווקיות (אלא אם ביקשת להסיר את הסכמתך). הודעות ייחשבו כנתקבלו 24 שעות לאחר שליחתן.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  אנו שומרים לעצמנו את הזכות לעדכן תנאי שימוש אלו בכל עת כדי לשקף שינויים בפרקטיקות שלנו, בטכנולוגיה,
                  בשירותים או בדרישות משפטיות. שינויים יכנסו לתוקף מיד עם פרסומם באתר.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  המשך שימוש באתר לאחר פרסום השינויים מהווה הסכמה לתנאים המעודכנים. אם אינך מסכים/ה לשינויים, אנא הפסק/י
                  את השימוש באתר וצור/י איתנו קשר. מומלץ לבדוק עמוד זה מעת לעת כדי להישאר מעודכן/ת.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-white p-4 rounded-lg">
                  <ul className="list-disc list-inside space-y-2 text-gray-600">
                    <li>
                      <strong>חלוקה:</strong> אם הוראה מסוימת נמצאת כבלתי תקפה, שאר התנאים יישארו בתוקף
                    </li>
                    <li>
                      <strong>אי מימוש:</strong> אי מימוש זכות לא מהווה ויתור עליה
                    </li>
                    <li>
                      <strong>העברה:</strong> אינך יכול להעביר את זכויותיך או חובותיך ללא אישור בכתב
                    </li>
                    <li>
                      <strong>הסכם מלא:</strong> תנאים אלו מהווים את ההסכם המלא בינך לבין החברה
                    </li>
                    <li>
                      <strong>שפה:</strong> במקרה של סתירה בין תרגומים, הגרסה העברית תקפה
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-700">
                    <strong>אימייל:</strong> hello@auto-mind.solutions
                  </p>
                  <p className="text-gray-700">
                  ...
                  <p className="text-gray-700 mt-2">
                    <strong>שעות פעילות:</strong> ראשון-חמישי, 9:00-18:00
                  </p>
                </div>
              </div>
