...
const faqs = [
  ...
  },
  {
    ...
    answer: 'אנחנו מעניקים תמיכה מתמשכת לפי החבילה שבחרת (30-90 יום). לאחר מכן ניתן להמשיך עם חבילת תחזוקה חודשית שכוללת גיבויים, עדכוני אבטחה, ושיפורים שוטפים.',
  },
];
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between gap-6">
                      <span className={`text-2xl sm:text-3xl font-extrabold transition-colors ${
