...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-16 md:py-24 px-4 sm:px-6 lg:px-12 relative overflow-hidden bg-[#f8fafc] z-10">
      {/* Decorative background elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none select-none opacity-40">
        <svg
          className="absolute -top-24 -left-24 text-[var(--color-primary)] opacity-10"
          width="600"
          height="600"
          viewBox="0 0 200 200"
          fill="none"
        ...
        <svg
          className="absolute -bottom-32 -right-32 text-[var(--color-primary)] opacity-10"
          width="800"
          height="800"
          viewBox="0 0 100 100"
          fill="none"
                      ...
                      <span
                        className={`text-2xl sm:text-3xl font-extrabold transition-colors ${
                          openIndex === index
                            ...
                            : "text-slate-800 group-hover:text-[var(--color-primary)]"
                        }`}
                      >
                        {faq.question}
                      </span>
                    ...
                    >
                      <div className="overflow-hidden">
                        <div className="pt-8 mt-8 border-t border-slate-100">
                          <p className="text-slate-600 leading-loose text-lg sm:text-xl font-medium">{faq.answer}</p>
                        </div>
                      </div>
                    </div>
                  </button>
