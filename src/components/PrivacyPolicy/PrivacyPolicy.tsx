        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="space-y-8 bg-white rounded-[32px] p-8 lg:p-12 border-4 border-[var(--color-charcoal)]">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                השירותים שלנו מיועדים למבוגרים מעל גיל 18. אנו לא אוספים במודע מידע אישי מילדים מתחת לגיל 18. אם גילית שמידע של ילד נאסף ללא הסכמת הורה, אנא צור/י איתנו קשר מיד כדי שנמחק את המידע.
              </p>
            </div>
