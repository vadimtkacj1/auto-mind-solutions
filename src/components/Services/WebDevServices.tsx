...
const SERVICES = [
  ...
  },
  {
    ...
    description: "חנות פיזית זה מצוין, אבל אתר מכירות אונליין חושף אתכם לכל הארץ ולכל העולם. הניסיון העשיר שלנו כולל בניית אתר חנות גמיש, פיתוח ו-בניית חנות וירטואלית בעלת קטלוג חכם, ביצוע בניית אתר איקומרס שנטען במילי-שניות, ואינטגרציה חלקה ובטוחה של בניית אתר עם סליקה.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="mt-6 text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            לכל עסק יש את ה-DNA שלו. אנו מציעים פתרונות מותאמים אישית לכל מודל עסקי
          </p>
        </motion.div>
