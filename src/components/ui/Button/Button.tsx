  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        cta: "bg-[var(--color-primary)] text-white shadow-lg shadow-[rgba(0,112,255,0.18)] hover:bg-[var(--color-primary-dark)] hover:brightness-110 active:scale-95 border border-transparent",
        brandOutline:
          "border-2 border-slate-300 bg-transparent text-slate-900 hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] active:scale-95",
        brandGlass:
          "border-2 border-white/15 bg-white/[0.06] text-white hover:bg-white/[0.1] active:scale-95",
        destructive:
      ...
      size: {
        ...
        nav: "h-12 rounded-lg px-8 text-lg font-extrabold",
        hero: "h-auto rounded-lg px-8 py-5 text-lg font-black",
        pill: "h-11 rounded-lg px-8 text-base font-extrabold",
